...
namespace DemoECummerApp.Security.Authentication
{
    public class BasicAuthenticationHandler : AuthenticationHandler<BasicAuthenticationOptions>
    {
        ...
        public BasicAuthenticationHandler(IOptionsMonitor<BasicAuthenticationOptions> options,
            ILoggerFactory logger, UrlEncoder encoder, ISystemClock clock, DemoDatabaseContext context)
        ...
        {
            Response.Headers["WWW-Authenticate"] = $"Basic realm=\"https://localhost:44383\", charset=\"UTF-8\"";
