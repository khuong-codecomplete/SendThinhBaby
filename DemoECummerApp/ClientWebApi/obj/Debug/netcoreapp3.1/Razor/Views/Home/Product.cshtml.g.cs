#pragma checksum "E:\INTERNdotnet\DemoECummerApp\ClientWebApi\Views\Home\Product.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "0d1baf63f063967ecdcc38d4c39bc528161affcb"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"0d1baf63f063967ecdcc38d4c39bc528161affcb", @"/Views/Home/Product.cshtml")]
    ...
    public class Views_Home_Product : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "0d1baf63f063967ecdcc38d4c39bc528161affcb3218", async() => {
                WriteLiteral(@"
    <meta charset=""utf-8"" />
    ...
    var
        accessToken = 'eyJhbGciOiJSUzI1NiIsImtpZCI6IkZGMUEzQzEyNzJFQzQyMzdFMUIxN0Y3NTk2OERFRkIyIiwidHlwIjoiYXQrand0In0.");
                WriteLiteral(@"2N0E5QUIxNTRGNjM2NjM5QzAzIiwiaWF0IjoxNjE1NTE1MDY2LCJzY29wZSI6WyJEZW1vRGF0YWJhc2UuUmVhZEFjY2VzcyJdLCJhbXIiOlsiZGF0YWJhc2UiXX0.uJDptZDDNoeavfXr1GRSnc_sHCm8EjMJXcl2-n5ya6yTZ8aVoZ82agI3WZIcNFTLunH6kWHjegKWzbAMLLlD1YXKjghXGXBEUZqowbopknifLexyNzm-VaqJx0Wn_FIgh9_r3HXC46CHmUVzmZ0uZdPn5c2Kyc31ox_AnDlHEGSWTzs_9pRH-cb6l2-2PZHaRh1QWiT85zY9czj0rpX1iU-FlnsyL68DNRddD6TSaUeKbUOHgeLUIzhthG94sbukyzLSRaXYAGT_6sfiIzlR_mfd0_BPhBs0Oc8AcpCZDdbqXRpEhOlZ0FGs9GLGIHX7pNMON2DSZSDdNRG3QGxKuA',
        ...
        function PostOrders() {
            // 1. Build order object to");
                WriteLiteral(@" match the model class Orders.cs.
            var order = {
                ...
                order.OrdersProducts.push(
                    {
                        ...
                        Finalprice: $(this).find('td.'+customerId+'').html(),
        ...
        function LoadProducts(searchText) {
            ...
            // ");
                WriteLiteral(@"Load products' details.
            $.ajax({
                        ...
                        $('#tblProducts')
                            .append($('<tr>')
                                .append($('<td>')
                                    ...
                                    .append($('<a>')
   ");
                WriteLiteral(@"                                     .attr({ 'href': value.productsdetail[0].url, 'target': '_blank' })
                                        .html('Amazon Link'))
                                    .append($('<input>')
                                        .attr({ 'type': 'button' })
                                        .val(""Add To Cart"")
        ...
        function AddToCart(productId, productName, qty, price) {
            ...
            var variablePrice = ""price"" + String(price);
            if (cartItem.length > 0) {
                var qtyTd = cartItem.find('td.qty');
                var newQty = parseInt(qtyTd.html()) + qty;
                qtyTd.html(newQty);
                cartItem.find('td.' + variablePrice + '').html('$' + (newQty * price).toFixed(2)).addClass(customerId);
            ...
            cartItem = $('#tblCart tbody')
                .append($('<tr>')
                    ...
                    .append($('<td class='+variablePrice+'>').html('$' + qty * price))
                    .append($('<td>')   
                        .append($('<a>')
                        ");
            ...
            PostCart(customerId,
                ...
                cartItem.find('td.'+variablePrice+'').html().replace('$', ''))
        }
        ...
        function PostCart(customerId, productId, qty, finalPrice) {
            ...
            $.ajax({
                url:");
                WriteLiteral(@" 'https://localhost:44383/api/Carts',
                type: ""POST"",
                contentType: ""application/json"",
                dataType: ""json"",
        ...
        function PutCart(cartItem) {
            var cart = {
                ...
                Qty: cartItem");
                WriteLiteral(@".find('td.qty').html(),
                Finalprice: cartItem.find('td.' + customerId + '').html().replace('$', '')
            };
...
");
            ...
            WriteLiteral("\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "0d1baf63f063967ecdcc38d4c39bc528161affcb16198", async() => {
                WriteLiteral(@"
    ...
    <div id=""Order"" class=""modal fade in"" role=""dialog"">
                ...
                WriteLiteral(@"                       <input type=""text"" class=""form-control""
                        ...
                        <div class=""form-group"">
                            ...
                            <div class=""col-sm-10"">
                                <input type=""text"" class=""form-control""
                                       id=""tx");
                WriteLiteral(@"tPostalCode"" placeholder=""Postal Code"" />
                            </div>
                        </div>
                        <div class=""form-group"">
                            <label class=""col-sm-2 control-label""
